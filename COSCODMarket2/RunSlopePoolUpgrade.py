...
from MongoDataBases import week_aba_years, db_names, week_aba_months
...
def pool3(db_name,keyWord):
    ...
    res_words_month = [OperateMongo(db_name, table_name).aba_rank_month(seed_word=keyWord) for table_name in week_aba_months]
...
if __name__ == '__main__':
    ...
    for db_name in db_names[1:2]:
        ...
        for keyWord in top_words[300:400]:
            ic(keyWord)
            # 2. 使用多进程
